...
namespace _0_Framework.Application
{
    public static class Tools
    {
        ...
        public static string ToDateMonthName(this DateTime date)
        {
            if (date == new DateTime()) return "";
            string month = CultureInfo.CurrentCulture.DateTimeFormat.GetMonthName(date.Month);
            return $"{month}, {date.Year}, {date.Day}";
        }
        public static string GetMonthName(this DateTime date)
        {
            if (date == new DateTime()) return "";
            string fullname = CultureInfo.CurrentCulture.DateTimeFormat.GetMonthName(date.Month);
            DateTime month;
        ...
        public static string ToMoney(this double myMoney)
        {
            ...
            return string.Format("{0:#.00}", Convert.ToDecimal(myMoney) / 100);
        }
